...
func TestShiftKnown(t *testing.T) {
	...
	expected_state[0] = []byte{0x00, 0x05, 0x0a, 0x0f}
	expected_state[1] = []byte{0x04, 0x09, 0x0e, 0x03}
	expected_state[2] = []byte{0x08, 0x0d, 0x02, 0x07}
	expected_state[3] = []byte{0x0c, 0x01, 0x06, 0x0b}
